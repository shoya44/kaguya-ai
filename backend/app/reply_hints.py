...
_CONSULT = re.compile(r'どうしたら|どうすれば|どうやって|教えて'
                      r'|(?:アドバイス|解決策|具体案|対処法|提案)(?:を|が|は)?(?:ほしい|欲しい|ください|して|ある|教えて)')
_EMPATHY = re.compile(r'疲れた|つらい|しんど|きつい|悲しい|落ち込|不安|最悪|泣き')

RESPONSE_PLAN = {
    'empathy': 'つらさや迷いの具体的な内容を受け止め、一緒に悩む。助言・解決策は求められたときだけ伝える。'
               '相手が話を続けたそうなら、その話に沿って反応したり一つ聞いてもよい。聞くだけの希望は尊重する。',
    'consult': '質問にはその内容に答える。解決策や助言を求められている場合だけ、気持ちを踏まえて具体案を短く伝える。'
