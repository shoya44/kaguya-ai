...
# --- 音声通話 --------------------------------------------------------------
# Gemini Liveの声。名前はGemini側の一覧に従う。ここを変えるとかぐやの声が変わる。
# 明るく若い声をかぐや寄りとして選んでいる。落ち着かせたいなら 'Kore' に戻す。
# 候補例: Leda / Zephyr / Aoede / Puck / Kore
# 名前が無効だと通話開始時に接続エラーになる（画面に音声名を出して分かるようにしている）。
VOICE_NAME = 'Leda'
