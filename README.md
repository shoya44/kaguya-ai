...
- リマインダーの時刻にはPC版の画面を前に出し、前に出せないときはタスクバーを点滅させます。吹き出しの「通話に出る」からそのまま音声通話を始められます
- ローカルカレンダー
- Open-Meteoによる天気取得
...
時刻になると、吹き出しとかぐやの呼びかけに加えて、PC版では画面が前に出ます。
別のウィンドウを操作中で前に出せないときは、タスクバーのアイコンが点滅します。
吹き出しの下の「通話に出る」を押すと、確認済みとして記録したうえで音声通話が始まります。
